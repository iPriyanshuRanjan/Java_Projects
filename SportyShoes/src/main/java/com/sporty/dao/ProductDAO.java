...
public class ProductDAO {
	...
	public Product getProductById(long id) {
		...
		List<Product> list = this.sessionFactory.getCurrentSession().createQuery("from Product where id=" + strId)
				.list();
		if (list.size() > 0)
	...
	public void deleteProduct(long id) {
		...
		// Pending:Purchase total is not updated in the purchase total - it shows the
		// old value
